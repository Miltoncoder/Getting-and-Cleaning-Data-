...
i<-match("subject", names(append_data))
append_data_clean_aux<-append_data[,c(i,measurement_index+1)]
...
summary_data<-aggregate(append_data_clean[,2:67], list(append_data_clean$subject), mean )
